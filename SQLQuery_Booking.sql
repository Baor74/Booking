...
VALUES (1, 'P101', N'Phòng VIP', 500, N'Có cửa sổ ra biển', 1,'img1.jpg'),
       ...
       (4, 'P201', N'Phòng đôi', 400, N'Có 1 giường đôi', 1,'401099211.jpg'),
       (4, 'P202', N'Phòng VIP', 600, N'Có bách khoa thư', 1,'img1.jpg'),
       (4, 'P301', N'Phòng gia đình', 1000, N'Có 2 giường đơn', 0,'img1.jpg'),
       (4, 'P302', N'Phòng đôi', 500, N'Có 2 giường đôi', 1,'img5.jpg'),
	   (5, 'P101', N'Phòng VIP', 500, N'Có cửa sổ ra biển', 1,'img1.jpg'),
       (5, 'P102', N'Phòng thường', 300, N'Có ghế salon', 0,'401099204.jpg'),
       (5, 'P201', N'Phòng đôi', 400, N'Có 1 giường đôi', 1,'401099211.jpg'),
       (5, 'P202', N'Phòng VIP', 600, N'Có bách khoa thư', 1,'img1.jpg'),
       (5, 'P301', N'Phòng gia đình', 1000, N'Có 2 giường đơn', 0,'img1.jpg'),
       (5, 'P302', N'Phòng đôi', 500, N'Có 2 giường đôi', 1,'img5.jpg'),
       (5, 'P401', N'Phòng đơn', 200, N'Có 1 giường đơn', 1,'img5.jpg'),
       (5, 'P402', N'Phòng VIP', 800, N'Có bể bơi riêng', 0,'img6.jpg'),
       (4, 'P501', N'Phòng gia đình', 1200, N'Có 3 giường đơn', 1,'sp1.webp'),
       (4, 'P502', N'Phòng đôi', 700, N'Có 2 giường đôi', 0,'401099211.jpg')

	   delete Dich_vu
INSERT INTO Dich_vu (Ma_khach_san, Ten_dich_vu, Mo_ta, Gia)
VALUES
    (1, N'Dịch vụ ăn uống', N'Nhà hàng, quầy bar', 150.00),
    (1, N'Dịch vụ giặt ủi', N'Giặt là nhanh chóng và tiện lợi', 50.00),
    (2, N'Dịch vụ spa', N'Trải nghiệm nghỉ dưỡng thư giãn', 300.00),
    (2, N'Dịch vụ hồ bơi', N'Hồ bơi rộng rãi và sạch sẽ', 80.00),
    (3, N'Dịch vụ phòng gym', N'Phòng tập đầy đủ trang thiết bị', 100.00),
    (3, N'Dịch vụ golf', N'Sân golf 18 lỗ với cảnh quan đẹp', 500.00);

INSERT INTO Khach_Hang (Ten_tai_khoan, Mat_khau, Ho_ten, Gioi_tinh, Ngay_sinh, Dia_chi, Email, SDT)
VALUES
	('user1', '123', N'user1',1,'1-1-2004', N'Tp.Hồ Chí Minh', 'user1@gmail.com','0123456789'),
	('baor123','123',N'Nguyễn Văn Hoàng Bảo',1,'11-29-2004',N'Quảng Trị','baonvhps343@fpt.edu.vn','0123762465')
...
Select * from Khach_san ks where ks.Thanh_pho like N'%Hồ %'

alter table Phong add hinh varchar(250);
