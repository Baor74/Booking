...
public class AdminController {
  ...
  @GetMapping("/admin/khachhang/maKhachHang")
  public String getEditProductPage(@RequestParam("maKhachHang") Integer maKhachHang) {
    return "/admin/user-list";
  }
...
//        khachHangRepo.findKhachHangByUsername("%" + name.orElse("") + "%"));
//    model.addAttribute("name", name.orElse(""));
//    return "";
//  }
//
//  @GetMapping("/admin/user/delete/{username}")
//  public String user_delete(@ModelAttribute("userEdit") KhachHang khachHang,
...
//  public String user_update(@Validated @ModelAttribute("userEdit") KhachHang khachHang,
...
//  public String product_delete(@ModelAttribute("productEdit") KhachSan khachSan,
...
//  public String product_update(@Validated @ModelAttribute("productEdit") KhachSan khachSan,
